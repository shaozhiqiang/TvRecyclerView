...
public class ColorFocusBorder extends AbsFocusBorder {
    ...
    private int mBorderStartColor =0;
    private int mBorderEndColor =0;
    ...
    private ColorFocusBorder(Context context, Builder builder) {
        ...
        this.mBorderStartColor = builder.mBorderStartColor;
        this.mBorderEndColor = builder.mBorderEndColor;
...
//            }
    ...
    public final static class Builder extends AbsFocusBorder.Builder{
        ...
        private int mBorderStartColor=0;//开始颜色
        private int mBorderEndColor = 0;//结束颜色
        ...
        public Builder borderGradientColor(@ColorInt int startColor,@ColorInt int endColor) {
            mBorderStartColor = startColor;
            mBorderEndColor = endColor;
            return this;
        }
